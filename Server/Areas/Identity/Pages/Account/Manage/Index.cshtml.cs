...
namespace FinalBlazorIndivisualUser.Server.Areas.Identity.Pages.Account.Manage
{
    public partial class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (success.Succeeded)
            {
                ...
                StatusMessage = "Your Full-name has been submitted successfully";
                return RedirectToPage();
            }
            else
            {
                return NotFound($"Unable to Save user with ID '{_userManager.GetUserId(User)}'.");
            }
        }
    }
}
